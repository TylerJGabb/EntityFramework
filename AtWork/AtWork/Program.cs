...
namespace AtWork
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string connectionString = "data source=PP-PORSCHE-01;initial catalog=polyprint;persist security info=True;user id=sa;password=MngDBsvr2008@polyprint;MultipleActiveResultSets=True;App=EntityFramework";
